...
Steps.defaultProps = {
  step4Description:
    'Celebrate the grand opening of your franchise fried chicken restaurant with a successful launch.',
  step4Title: 'Grand Opening',
  step3Title: 'Training and Support',
  step2Title: 'Submit Franchise Application',
  step1Title: 'Choose Your Location',
  step1Description:
    'Select a prime location for your franchise fried chicken restaurant.',
  step3Description:
    'Receive comprehensive training and ongoing support from our experienced team.',
  step2Description:
    'Fill out the franchise application form and submit it for review.',
}
